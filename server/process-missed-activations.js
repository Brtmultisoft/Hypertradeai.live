/**
 * Script to process missed trade activations from yesterday
 *
 * This script will:
 * 1. Find all trade activations from yesterday with profit_status = 'pending'
 * 2. Check if these users have active investments
 * 3. Process the daily profit for these users
 * 4. Update the trade activation records
 */
...
async function processMissedActivations() {
  try {
