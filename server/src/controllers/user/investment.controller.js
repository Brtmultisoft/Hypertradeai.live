            ...
            try {
                ...
                if (!user.refer_id) {
                    ...
                    if (referrer) {
                        ...
                        if (hasReferrerInvested) {
                            // Calculate referral bonus - fixed 3% of investment amount as per plan
                            const referralBonusRate = 3; // Fixed 3% as per plan
                            console.log(`Using fixed ${referralBonusRate}% referral bonus rate`);
